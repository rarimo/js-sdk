...
export const Proposal = {
  encode(message: Proposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.submitBlock !== 0) {
      writer.uint32(40).uint64(message.submitBlock);
    }
    if (message.depositEndBlock !== 0) {
      writer.uint32(48).uint64(message.depositEndBlock);
    }
    for (const v of message.totalDeposit) {
      Coin.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.votingStartBlock !== 0) {
      writer.uint32(64).uint64(message.votingStartBlock);
    }
    if (message.votingEndBlock !== 0) {
      writer.uint32(72).uint64(message.votingEndBlock);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.depositEndBlock = longToNumber(reader.uint64() as Long);
          break;
        case 7:
          message.totalDeposit.push(Coin.decode(reader, reader.uint32()));
          break;
        case 8:
          message.votingStartBlock = longToNumber(reader.uint64() as Long);
          break;
        case 9:
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      depositEndBlock: isSet(object.depositEndBlock) ? Number(object.depositEndBlock) : 0,
      totalDeposit: Array.isArray(object?.totalDeposit) ? object.totalDeposit.map((e: any) => Coin.fromJSON(e)) : [],
      votingStartBlock: isSet(object.votingStartBlock) ? Number(object.votingStartBlock) : 0,
      votingEndBlock: isSet(object.votingEndBlock) ? Number(object.votingEndBlock) : 0,
    };
  },
  ...
  toJSON(message: Proposal): unknown {
    ...
    message.depositEndBlock !== undefined && (obj.depositEndBlock = Math.round(message.depositEndBlock));
    if (message.totalDeposit) {
      obj.totalDeposit = message.totalDeposit.map((e) => e ? Coin.toJSON(e) : undefined);
    } else {
      obj.totalDeposit = [];
    }
    message.votingStartBlock !== undefined && (obj.votingStartBlock = Math.round(message.votingStartBlock));
    message.votingEndBlock !== undefined && (obj.votingEndBlock = Math.round(message.votingEndBlock));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Proposal>, I>>(object: I): Proposal {
    ...
    message.depositEndBlock = object.depositEndBlock ?? 0;
    message.totalDeposit = object.totalDeposit?.map((e) => Coin.fromPartial(e)) || [];
    message.votingStartBlock = object.votingStartBlock ?? 0;
...
function createBaseDepositParams(): DepositParams {
  return { minDeposit: [], maxDepositPeriod: 0 };
}
...
export const DepositParams = {
  encode(message: DepositParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.maxDepositPeriod !== 0) {
      writer.uint32(16).uint64(message.maxDepositPeriod);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.maxDepositPeriod = longToNumber(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): DepositParams {
    return {
      ...
      maxDepositPeriod: isSet(object.maxDepositPeriod) ? Number(object.maxDepositPeriod) : 0,
    };
  },
  ...
  toJSON(message: DepositParams): unknown {
    ...
    message.maxDepositPeriod !== undefined && (obj.maxDepositPeriod = Math.round(message.maxDepositPeriod));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DepositParams>, I>>(object: I): DepositParams {
    ...
    message.maxDepositPeriod = object.maxDepositPeriod ?? 0;
    return message;
  },
};

function createBaseVotingParams(): VotingParams {
  return { votingPeriod: 0 };
}

export const VotingParams = {
  encode(message: VotingParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.votingPeriod !== 0) {
      writer.uint32(8).uint64(message.votingPeriod);
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VotingParams {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.votingPeriod = longToNumber(reader.uint64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): VotingParams {
    return { votingPeriod: isSet(object.votingPeriod) ? Number(object.votingPeriod) : 0 };
  },
