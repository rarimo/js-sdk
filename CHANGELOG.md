...
- `@rarimo/client`:
  - Expose helpers
  - add keplr helpers
  - add getting chain info method for `RarimoClient`
...
### Added
- `@rarimo/client` - CreateIdentityGISTTransferOp, CreateIdentityStateTransferOp message types

## [2.0.0-rc.30] - 2023-11-02
### Fixed
- `@rarimo/react-nft-checkout` - Internal errors

## [2.0.0-rc.29] - 2023-11-01
### Changed
- `@rarimo/shared` - Dex pairs oracle service api base URL
- `@rarimo/nft-checkout` - Checkout service api base URL
...
### Fixed
- `@rarimo/nft-checkout` - `CheckoutOperation` type

## [2.0.0-rc.25] - 2023-09-19
### Added
- `@rarimo/nft-checkout` - `getBundlerAddress` method

### Changed
- `@rarimo/nft-checkout` - `EVMOperation` modifying salt

## [2.0.0-rc.24] - 2023-09-12
### Fixed
- `@rarimo/zkp-gen-iden3` - `endianSwappedCoreStateHashHex`

## [2.0.0-rc.23] - 2023-09-07
### Added
- `@rarimo/client` - Build rarimo querier opts

### Changed
- `@rarimo/zkp-gen-iden3` - Fetching merkle proof by block height
...
[Unreleased]: https://github.com/rarimo/js-sdk/compare/2.4.0...HEAD
...
[2.0.0-rc.29]: https://github.com/rarimo/js-sdk/compare/2.0.0-rc.28...2.0.0-rc.29
...
[2.0.0-rc.24]: https://github.com/rarimo/js-sdk/compare/2.0.0-rc.23...2.0.0-rc.24
